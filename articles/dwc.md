...
For more technical questions on the DWC, see: [https://cds.cern.ch/record/702443/files/sl-note-98-023.pdf](https://cds.cern.ch/record/702443/files/sl-note-98-023.pdf)

DWCs or delay wire chambers are spark chambers that allow us to track particles to incrediblr precision. 
...
$$ X \\quad = \\quad \\left( t_{R} - t_{L} \\right) \\cdot  \\text{slope}{x}  +  \\text{offset}{x} $$
